...
def page(song):
    ...
    description = TEXTOS.get(slug, f'{title} de DejavuUrbe, single publicado el {fecha_humana(song["fecha"])}.')
    schema = {
        ...
        '@graph':[
            ...
            {'@type':'MusicGroup','@id':ARTIST_ID,'name':'DejavuUrbe','alternateName':['Dejavu Urbe','Deja Vu Urbe','Dejavú Urbe'],'url':f'{BASE}/','description':'Banda de rock argentino formada en Buenos Aires en 1999, activa en una primera etapa hasta 2002 y reunida nuevamente desde 2025.','genre':['Rock argentino','Rock en español'],'foundingDate':'1999','foundingLocation':{'@type':'Place','name':'Buenos Aires, Argentina'},'sameAs':['https://www.youtube.com/@DejavuUrbe','https://music.youtube.com/@dejavuurbe','https://dejavuurbe.bandcamp.com/','https://www.instagram.com/dejavuurbe/','https://www.facebook.com/profile.php?id=61578015827932','https://www.discogs.com/label/4655592-DejavuUrbe','https://www.vowave.com/DejavuUrbe','https://musicbrainz.org/artist/501f158f-7f8a-4ea5-92c2-a7993edc0bc7']},
